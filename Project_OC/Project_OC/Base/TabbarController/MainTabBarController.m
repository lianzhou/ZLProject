...
-(void)setUpTabBar{
    //设置背景色 去掉分割线
    [self setValue:[ZLTabBar new] forKey:@"tabBar"];
...
-(void)setUpAllChildViewController{
    ...
    ViewController *msgVC = [ViewController new];
...
-(void)setupChildViewController:(UIViewController*)controller title:(NSString *)title imageName:(NSString *)imageName seleceImageName:(NSString *)selectImageName{
    ...
    //未选中字体颜色
    [controller.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:KBlackColor,NSFontAttributeName:KDEFAULTFONT(10.0f)} forState:UIControlStateNormal];
    
    //选中字体颜色
    [controller.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:KRedColor,NSFontAttributeName:KDEFAULTFONT(10.0f)} forState:UIControlStateSelected];
    //包装导航控制器
