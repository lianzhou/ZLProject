...
-(void)updateNavigationItems{
    if (_isShowCloseBtn) {
        if (self.webView.canGoBack) {
            ...
            [self addNavigationItemWithImageNames:@[@"icon_nav_btn_back",@"close_icon"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2000,@2001]];
            ...
            if (kiOS9Later) {
                ...
                [self addNavigationItemWithImageNames:@[@"icon_nav_btn_back"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2001]];
            }
        }
    }
}
