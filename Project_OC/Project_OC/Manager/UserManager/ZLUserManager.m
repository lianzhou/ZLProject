...
#import "ZLUserManager.h"
//#import <UMSocialCore/UMSocialCore.h>
@implementation ZLUserManager

SHARED_INSTANCE_DEFINE(ZLUserManager);
...
-(void)loginToServer:(NSDictionary *)params completion:(loginBlock)completion{
    ...
    [PPNetworkHelper POST:URL_user_login parameters:params success:^(id responseObject) {
...
-(void)autoLoginToServer:(loginBlock)completion{
    ...
    [ZLNetworkHelper  POST:@"" parameters:@{} completion:^(ZLNetworkRsponse * _Nonnull rsp) {
        if( rsp.success){
    ...
    [PPNetworkHelper POST:URL_user_auto_login parameters:nil success:^(id responseObject) {
        [self LoginSuccess:responseObject completion:completion];
...
-(void)saveUserInfo{
    ...
    if (self.zlUserInfo) {
        ...
        NSDictionary *dic = [self.zlUserInfo modelToJSONObject];
...
-(BOOL)loadUserInfo{
    ...
    if (userDic) {
        self.zlUserInfo = [ZLUserInfo modelWithJSON:userDic];
        return YES;
    }
    return NO;
