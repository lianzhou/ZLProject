...
- (void)viewDidLoad {
    ...
    SDCycleScrollView *cycleScrollView3 = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 100, kScreenW, 180) delegate:self placeholderImage:[UIImage imageNamed:@"placeholder"]];
