...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message sureBtn:(NSString *)sureTitle cancleBtn:(NSString *)cancleTitle
{
    if (self == [super init]) {
        ...
        if (cancleTitle && sureTitle) {
            ...
            NSMutableAttributedString *cancleString = [[NSMutableAttributedString alloc] initWithString:cancleTitle attributes: @{NSFontAttributeName: [UIFont fontWithName:@"PingFangSC-Regular" size: 18],NSForegroundColorAttributeName: [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1.0]}];
            ...
            [self.cancleBtn setAttributedTitle:cancleString forState:(UIControlStateNormal)];
        ...
        if(sureTitle && cancleTitle){
            ...
            NSMutableAttributedString *sureString = [[NSMutableAttributedString alloc] initWithString:sureTitle attributes: @{NSFontAttributeName: [UIFont fontWithName:@"PingFangSC-Medium" size: 18],NSForegroundColorAttributeName: [UIColor colorWithRed:252/255.0 green:87/255.0 blue:121/255.0 alpha:1.0]}];
            [self.sureBtn setAttributedTitle:sureString forState:(UIControlStateNormal)];
            self.sureBtn.tag = 2;
...
- (void)show {
    ...
    [currentCtrl.view addSubview:self];
...
-(UILabel *)GetAdaptiveLable:(CGRect)rect AndText:(NSString *)contentStr andIsTitle:(BOOL)isTitle{
    ...
    if (isTitle) {
        mAttrStr = [[NSMutableAttributedString alloc] initWithString:contentStr attributes: @{NSFontAttributeName: [UIFont fontWithName:@"PingFangSC-Medium" size: 18],NSForegroundColorAttributeName: [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1.0]}];
    }else{
        mAttrStr = [[NSMutableAttributedString alloc] initWithString:contentStr attributes: @{NSFontAttributeName: KDEFAULTFONT(14),NSForegroundColorAttributeName: [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1.0]}];
    }
