...
- (void)initFunctions{
    ...
    bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, kScreenH-80-ZLSafeHeight, kScreenW, 80)];
    bottomView.backgroundColor = [UIColor blackColor];
    [self.view addSubview:bottomView];
    editScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, 50)];
    ...
    // 添加左右编辑框拖动条
    leftDragView = [[DragEditView alloc] initWithFrame:CGRectMake(-(kScreenW-50), 0, kScreenW, 50) Left:YES];
    ...
    rightDragView = [[DragEditView alloc] initWithFrame:CGRectMake((kScreenW-50), 0, kScreenW, 50) Left:NO];
    ...
    UIButton *doneBtn = [[UIButton alloc] initWithFrame:CGRectMake(kScreenW-60, 50, 60, 30)];
    ...
    self.endTime = 10;
    self.startPointX = 50;
    self.endPointX = kScreenW-50;
    self.IMG_Width = (kScreenW-100)/10;
}
    ...
    switch (gesture.state) {
        ...
        case UIGestureRecognizerStateChanged:
        {
            ...
            if (_isDraggingLeftOverlayView){
                ...
                center.x += deltaX;
                CGFloat durationTime = (kScreenW-100)*2/10; // 最小范围2秒
                BOOL flag = (self.endPointX-point.x)>durationTime;
                
                if (center.x >= (50-kScreenW/2) && flag) {
                ...
                if (center.x <= (kScreenW-50+kScreenW/2) && flag) {
                ...
                if (currentOffSet.x >= 0 && currentOffSet.x <= (editScrollView.contentSize.width-kScreenW)) {
...
- (void)initPlayerWithVideoUrl:(NSURL *)videlUrl{
    ...
    self.playerLayer.frame = CGRectMake(0, 80, self.view.bounds.size.width, kScreenW-160);
...
#pragma mark  - 开启计时器
- (void)startTimer{
    double duarationTime = (self.endPointX-self.startPointX-20)/kScreenW*10;
    line.hidden = NO;
