...
#define ZColor(r, g, b) [UIColor colorWithRed:(r) / 255.0 green:(g) / 255.0 blue:(b) / 255.0 alpha:1]
...
- (void)show {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.mainView.top = kScreenH - 260-ZLSafeHeight;
    }];
}
...
- (UIButton *)cancelBtn {
    if (!_cancelBtn) {
        ...
        [_cancelBtn setTitleColor:ZColor(85, 85, 85) forState:UIControlStateNormal];
...
- (UIButton *)confirmBtn {
    if (!_confirmBtn) {
        ...
        [_confirmBtn setTitleColor:ZColor(255, 126, 0) forState:UIControlStateNormal];
