...
@implementation ZLEncryptManager
...
+ (NSData *)excuteAES128WithData:(NSData *)inputData
    ...
    return [ZLEncryptManager encryptWithData:inputData secureKey:key algorithm:kCCAlgorithmAES128 operation:operation];
}
...
+ (NSData *)excuteDESWithData:(NSData *)inputData
                    secureKey:(NSData *)key
                    operation:(CCOperation)operation {
    return [ZLEncryptManager encryptWithData:inputData secureKey:key algorithm:kCCAlgorithmDES operation:operation];
}

+ (NSData *)excute3DESWithData:(NSData *)inputData
                     secureKey:(NSData *)key
                     operation:(CCOperation)operation {
    return [ZLEncryptManager encryptWithData:inputData secureKey:key algorithm:kCCAlgorithm3DES operation:operation];
}

+ (NSData *)excuteCASTWithData:(NSData *)inputData
                     secureKey:(NSData *)key
                     operation:(CCOperation)operation {
    return [ZLEncryptManager encryptWithData:inputData secureKey:key algorithm:kCCAlgorithmCAST operation:operation];
}
